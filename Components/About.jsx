...
function App() {
  ...
  return (
    <>
      <section className="relative min-h-[500px] flex items-center justify-center animate__animated animate__fadeIn">
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-[url('/images/b.jpg')] bg-cover bg-center" style={{ backgroundImage: "url('/images/c.jpg')" }}>
            <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-black/50"></div>
          </div>
        </div>
        <div className="container mx-auto px-4 relative z-10 animate__animated animate__zoomIn">
          <div className="max-w-3xl mx-auto text-center text-white">
            <h1 className="text-4xl font-bold mb-8 animate__animated animate__bounceIn">About Us</h1>
            <p className="text-[14px] text-center leading-relaxed">
              At Zenix, we're dedicated to delivering exceptional digital solutions that drive business growth.
            </p>
          </div>
      ...
      <section className="py-16 px-6 md:px-12 lg:px-24 bg-white animate__animated animate__fadeInUp">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-800 animate__animated animate__lightSpeedInRight">
            <span className="text-red-500">Team</span> Members
          </h2>
          <p className="text-gray-500 max-w-2xl mx-auto mt-4 animate__animated animate__fadeIn">
            Meet our passionate professionals.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
          {teamMembers.map((member, index) => (
            <div key={index} className="bg-white min-h-[320px] rounded-lg relative shadow-lg animate__animated animate__flipInY">
